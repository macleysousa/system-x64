...
export class DateTime {
    ...
    private DateTime: Date = new Date('0001-01-01T00:00:00.000Z');
    private DateTimeUtc: Date = new Date('0001-01-01T03:00:00.000Z');
    ...
    public static Now = new Date(new Date().getTime() - (new Date().getTimezoneOffset() * 60000));
    public static UtcNow = new Date();

    public DayOfWeek: number = 0;

    private setDate(dateTime: Date) {
    ...
    ToString(format: format = undefined, culture: culture = undefined) {
